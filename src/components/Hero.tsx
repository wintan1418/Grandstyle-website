...
const HERO_VIDEO =
  "https://res.cloudinary.com/v3bh8bz0/video/upload/v1789742544/featured/grandstyle_final.mp4";

const HERO_POSTER =
  "https://res.cloudinary.com/v3bh8bz0/video/upload/so_0,q_auto:best,f_jpg/featured/grandstyle_final.jpg";
