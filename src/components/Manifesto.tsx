      ...
      <div className="container-edge">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className="eyebrow text-crimson">A Manifesto</span>
            <span className="hairline bg-crimson" />
          </div>

          <h2
            id="manifesto-heading"
            className="font-display text-display-lg font-medium text-ink leading-[1.08] tracking-tight text-balance"
          >
